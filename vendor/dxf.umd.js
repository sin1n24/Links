/*!
 * Vendored browser build of the `dxf` npm package (v5.3.1)
 * https://github.com/bjnortier/dxf - MIT License, Copyright (c) 2014-2018 Ben Nortier
 * Used by dxf_io.js to parse AutoCAD DXF files (POLYLINE/LWPOLYLINE/CIRCLE,
 * including bulge-arc segmentation) in place of the original hand-rolled
 * parser, which could not read lightweight polylines (DXF2000+/LWPOLYLINE).
 * Rebuild with: npm install dxf@5.3.1 && cp node_modules/dxf/dist/dxf.js vendor/dxf.umd.js
 */
...
},{"./common":14}],29:[function(require,module,exports){
"use strict";
...
},{"./common":14}],31:[function(require,module,exports){
"use strict";
...
},{"../util/logger":42}],34:[function(require,module,exports){
"use strict";
...
function _interopRequireDefault(e) { return e && e.__esModule ? e : { "default": e }; }
},{"./Helper":1,"./config":3,"./denormalise":4,"./groupEntitiesByLayer":7,"./parseString":35,"./toPolylines":36,"./toSVG":37,"./util/colors":39}],35:[function(require,module,exports){
"use strict";
...
},{"./handlers/blocks":8,"./handlers/entities":9,"./handlers/header":31,"./handlers/objects":32,"./handlers/tables":33,"./util/logger":42}],36:[function(require,module,exports){
"use strict";
...
var _default = exports["default"] = function _default(parsed) {
  ...
  var polylines = entities.map(function (entity) {
    ...
    if (_colors["default"][colorNumber] === undefined) {
      _logger["default"].warn('Color index', colorNumber, 'invalid, defaulting to black');
      colorNumber = 0;
    }
    return {
...
},{"./applyTransforms":2,"./denormalise":4,"./entityToPolyline":5,"./util/colors":39,"./util/logger":42,"vecks":164}],37:[function(require,module,exports){
"use strict";
...
var arc = function arc(entity) {
  ...
  var _addFlipXIfApplicable4 = addFlipXIfApplicable(entity, {
    ...
    bbox = _addFlipXIfApplicable4.bbox,
    element = _addFlipXIfApplicable4.element;
  return (0, _transformBoundingBoxAndElement["default"])(bbox, element, entity.transforms);
};
...
},{"./denormalise":4,"./entityToPolyline":5,"./getRGBForEntity":6,"./util/logger":42,"./util/rgbToColorAttribute":43,"./util/rotate":44,"./util/toPiecewiseBezier":46,"./util/transformBoundingBoxAndElement":47,"vecks":164}],38:[function(require,module,exports){
"use strict";
 ...
 */
var _default = exports["default"] = function _default(t, degree, points, knots, weights) {
...
},{"./round10":45}],39:[function(require,module,exports){
"use strict";
 ...
 */
var _default = exports["default"] = function _default(from, to, bulge, resolution) {
...
},{"vecks":164}],41:[function(require,module,exports){
"use strict";
 ...
 */
var _default = exports["default"] = function _default(k, controlPoints, knots, newKnot) {
  var x = knots;
  var b = controlPoints;
...
},{"../config":3}],43:[function(require,module,exports){
"use strict";
 ...
 * @param angle the rotation angle
 */
var _default = exports["default"] = function _default(p, angle) {
  return {
...
var _default = exports["default"] = function _default(value, exp) {
 ...
 */
var checkPinned = exports.checkPinned = function checkPinned(k, knots) {
  // Pinned at the start
  for (var i = 1; i < k; ++i) {
    if (knots[i] !== knots[0]) {
...
var multiplicity = exports.multiplicity = function multiplicity(knots, index) {
  var m = 1;
 ...
 */
var computeInsertions = exports.computeInsertions = function computeInsertions(k, knots) {
  var inserts = [];
  var i = k;
...
var _default = exports["default"] = function _default(k, controlPoints, knots) {
  checkPinned(k, knots);
...
},{"./insertKnot":41}],47:[function(require,module,exports){
"use strict";
...
},{"vecks":164}],48:[function(require,module,exports){
...
},{"./_getNative":97,"./_root":132}],49:[function(require,module,exports){
...
},{"./_hashClear":104,"./_hashDelete":105,"./_hashGet":106,"./_hashHas":107,"./_hashSet":108}],50:[function(require,module,exports){
...
},{"./_listCacheClear":116,"./_listCacheDelete":117,"./_listCacheGet":118,"./_listCacheHas":119,"./_listCacheSet":120}],51:[function(require,module,exports){
var getNative = require('./_getNative'),
    root = require('./_root');
...
},{"./_getNative":97,"./_root":132}],52:[function(require,module,exports){
...
},{"./_mapCacheClear":121,"./_mapCacheDelete":122,"./_mapCacheGet":123,"./_mapCacheHas":124,"./_mapCacheSet":125}],53:[function(require,module,exports){
var getNative = require('./_getNative'),
    root = require('./_root');
...
},{"./_getNative":97,"./_root":132}],54:[function(require,module,exports){
var getNative = require('./_getNative'),
    root = require('./_root');
...
},{"./_getNative":97,"./_root":132}],55:[function(require,module,exports){
...
},{"./_ListCache":50,"./_stackClear":133,"./_stackDelete":134,"./_stackGet":135,"./_stackHas":136,"./_stackSet":137}],56:[function(require,module,exports){
...
},{"./_getNative":97,"./_root":132}],59:[function(require,module,exports){
/**
...
},{"./_baseTimes":79,"./_isIndex":112,"./isArguments":141,"./isArray":142,"./isBuffer":144,"./isTypedArray":151}],62:[function(require,module,exports){
/**
...
},{"./_baseAssignValue":67,"./eq":140}],64:[function(require,module,exports){
var eq = require('./eq');
...
},{"./eq":140}],65:[function(require,module,exports){
...
},{"./_copyObject":88,"./keys":152}],66:[function(require,module,exports){
var copyObject = require('./_copyObject'),
...
},{"./_copyObject":88,"./keysIn":153}],67:[function(require,module,exports){
...
},{"./_Stack":55,"./_arrayEach":59,"./_assignValue":63,"./_baseAssign":65,"./_baseAssignIn":66,"./_cloneBuffer":82,"./_copyArray":87,"./_copySymbols":89,"./_copySymbolsIn":90,"./_getAllKeys":94,"./_getAllKeysIn":95,"./_getTag":102,"./_initCloneArray":109,"./_initCloneByTag":110,"./_initCloneObject":111,"./isArray":142,"./isBuffer":144,"./isMap":147,"./isObject":148,"./isSet":150,"./keys":152,"./keysIn":153}],69:[function(require,module,exports){
...
},{"./isObject":148}],70:[function(require,module,exports){
...
},{"./_arrayPush":62,"./isArray":142}],71:[function(require,module,exports){
...
},{"./_Symbol":56,"./_getRawTag":99,"./_objectToString":130}],72:[function(require,module,exports){
...
},{"./_baseGetTag":71,"./isObjectLike":149}],73:[function(require,module,exports){
...
},{"./_getTag":102,"./isObjectLike":149}],74:[function(require,module,exports){
...
},{"./_isMasked":114,"./_toSource":138,"./isFunction":145,"./isObject":148}],75:[function(require,module,exports){
var getTag = require('./_getTag'),
    isObjectLike = require('./isObjectLike');
...
},{"./_getTag":102,"./isObjectLike":149}],76:[function(require,module,exports){
var baseGetTag = require('./_baseGetTag'),
...
},{"./_baseGetTag":71,"./isLength":146,"./isObjectLike":149}],77:[function(require,module,exports){
...
},{"./_isPrototype":115,"./_nativeKeys":127}],78:[function(require,module,exports){
var isObject = require('./isObject'),
...
},{"./_isPrototype":115,"./_nativeKeysIn":128,"./isObject":148}],79:[function(require,module,exports){
/**
...
},{"./_Uint8Array":57}],82:[function(require,module,exports){
var root = require('./_root');
...
},{"./_root":132}],83:[function(require,module,exports){
...
},{"./_Symbol":56}],86:[function(require,module,exports){
var cloneArrayBuffer = require('./_cloneArrayBuffer');
...
},{"./_assignValue":63,"./_baseAssignValue":67}],89:[function(require,module,exports){
var copyObject = require('./_copyObject'),
...
},{"./_copyObject":88,"./_getSymbols":100}],90:[function(require,module,exports){
var copyObject = require('./_copyObject'),
...
},{"./_copyObject":88,"./_getSymbolsIn":101}],91:[function(require,module,exports){
var root = require('./_root');
...
},{"./_root":132}],92:[function(require,module,exports){
var getNative = require('./_getNative');
...
},{"./_getNative":97}],93:[function(require,module,exports){
...
},{"./_baseGetAllKeys":70,"./_getSymbols":100,"./keys":152}],95:[function(require,module,exports){
var baseGetAllKeys = require('./_baseGetAllKeys'),
    getSymbolsIn = require('./_getSymbolsIn'),
    keysIn = require('./keysIn');
...
},{"./_baseGetAllKeys":70,"./_getSymbolsIn":101,"./keysIn":153}],96:[function(require,module,exports){
...
},{"./_isKeyable":113}],97:[function(require,module,exports){
...
},{"./_baseIsNative":74,"./_getValue":103}],98:[function(require,module,exports){
...
},{"./_overArg":131}],99:[function(require,module,exports){
var Symbol = require('./_Symbol');
...
},{"./_Symbol":56}],100:[function(require,module,exports){
...
},{"./_arrayFilter":60,"./stubArray":154}],101:[function(require,module,exports){
var arrayPush = require('./_arrayPush'),
...
},{"./_arrayPush":62,"./_getPrototype":98,"./_getSymbols":100,"./stubArray":154}],102:[function(require,module,exports){
...
},{"./_DataView":48,"./_Map":51,"./_Promise":53,"./_Set":54,"./_WeakMap":58,"./_baseGetTag":71,"./_toSource":138}],103:[function(require,module,exports){
/**
...
},{"./_nativeCreate":126}],107:[function(require,module,exports){
var nativeCreate = require('./_nativeCreate');
...
},{"./_nativeCreate":126}],108:[function(require,module,exports){
var nativeCreate = require('./_nativeCreate');
...
},{"./_nativeCreate":126}],109:[function(require,module,exports){
/** Used for built-in method references. */
var objectProto = Object.prototype;
...
},{"./_cloneArrayBuffer":81,"./_cloneDataView":83,"./_cloneRegExp":84,"./_cloneSymbol":85,"./_cloneTypedArray":86}],111:[function(require,module,exports){
...
},{"./_baseCreate":69,"./_getPrototype":98,"./_isPrototype":115}],112:[function(require,module,exports){
...
},{"./_coreJsData":91}],115:[function(require,module,exports){
/** Used for built-in method references. */
var objectProto = Object.prototype;
...
},{"./_assocIndexOf":64}],118:[function(require,module,exports){
var assocIndexOf = require('./_assocIndexOf');
...
},{"./_assocIndexOf":64}],119:[function(require,module,exports){
var assocIndexOf = require('./_assocIndexOf');
...
},{"./_assocIndexOf":64}],120:[function(require,module,exports){
var assocIndexOf = require('./_assocIndexOf');
...
},{"./_assocIndexOf":64}],121:[function(require,module,exports){
...
},{"./_Hash":49,"./_ListCache":50,"./_Map":51}],122:[function(require,module,exports){
...
},{"./_freeGlobal":93}],130:[function(require,module,exports){
/** Used for built-in method references. */
var objectProto = Object.prototype;
...
},{"./_ListCache":50}],134:[function(require,module,exports){
/**
...
},{"./_ListCache":50,"./_Map":51,"./_MapCache":52}],138:[function(require,module,exports){
/** Used for built-in method references. */
var funcProto = Function.prototype;
...
},{"./_baseClone":68}],140:[function(require,module,exports){
/**
 * Performs a
...
},{"./_baseIsArguments":72,"./isObjectLike":149}],142:[function(require,module,exports){
/**
...
},{"./isFunction":145,"./isLength":146}],144:[function(require,module,exports){
var root = require('./_root'),
...
},{"./_root":132,"./stubFalse":155}],145:[function(require,module,exports){
var baseGetTag = require('./_baseGetTag'),
    isObject = require('./isObject');
...
},{"./_baseGetTag":71,"./isObject":148}],146:[function(require,module,exports){
/** Used as references for various `Number` constants. */
var MAX_SAFE_INTEGER = 9007199254740991;
...
},{"./_baseIsMap":73,"./_baseUnary":80,"./_nodeUtil":129}],148:[function(require,module,exports){
/**
...
},{"./_baseIsSet":75,"./_baseUnary":80,"./_nodeUtil":129}],151:[function(require,module,exports){
...
},{"./_baseIsTypedArray":76,"./_baseUnary":80,"./_nodeUtil":129}],152:[function(require,module,exports){
...
},{"./_arrayLikeKeys":61,"./_baseKeys":77,"./isArrayLike":143}],153:[function(require,module,exports){
var arrayLikeKeys = require('./_arrayLikeKeys'),
...
},{"./_arrayLikeKeys":61,"./_baseKeysIn":78,"./isArrayLike":143}],154:[function(require,module,exports){
/**
...
},{"./V2":162}],157:[function(require,module,exports){
"use strict";
...
var _default = Box3;
exports["default"] = _default;
},{"./V3":163}],158:[function(require,module,exports){
"use strict";
...
var _default = Line2;
exports["default"] = _default;
},{"./V2":162}],159:[function(require,module,exports){
"use strict";
...
var _default = Line3;
exports["default"] = _default;
},{"./V3":163}],160:[function(require,module,exports){
"use strict";
...
exports["default"] = _default;
},{"./V3":163}],162:[function(require,module,exports){
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
},{"./Box2":156,"./Box3":157,"./Line2":158,"./Line3":159,"./Plane3":160,"./Quaternion":161,"./V2":162,"./V3":163}]},{},[34])(34)
});
